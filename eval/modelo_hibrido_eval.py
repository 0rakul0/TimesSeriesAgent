...
CAMINHO_DADOS = "../data/dados_prio3_brent.csv"
PASTA_JSON = "../output_noticias"
MODELO_BASELINE = "../models/lstm_baseline_price_prio3.pt"
HTML_SAIDA = "../img/previsao_baseline_hibrido_final_prio3.html"
DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu")
SEQ_LEN_DEFAULT = 30
CSV_FRASES = "../data/frases_impacto_clusters.csv"
EMB_PATH = "../modelos/embeddings_frases.npy"
...
# ============== BUSCAR SIMILARES ==============
def buscar_similares(motivo, meta_df, emb_matrix=None, top_k=4, sim_threshold=0.7):
    resultados = []
...
def carregar_modelo(model_path):
    ...
    from train.model_baseline_lstm import LSTMPrice
